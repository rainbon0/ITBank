...
<!-- 																숫자를 받는 input에 (전화번호, 카드정보 등) onkeyup 추가 -->
															<input type="text" class="form-control" id="c_card" name="c_card" 
																   placeholder="ex) 1234-1234-1234-1234" maxlength="19" onKeyup="this.value=this.value.replace(/[^0-9]/g,''); autoHypen(this);" required>
														</div>
													</div>
													<div class="form-group row">
														...
														<div class="col-md-6">
															...
															<input type="text" class="form-control" 
																   id="c_cvv" name="c_cvv"
																   placeholder="ex) 123" maxlength="3" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" required>
														</div>
														<div class="col-md-6">
															...
															<input type="text" class="form-control" 
																   ...
																   placeholder="MM/YY" maxlength="5" onKeyup="this.value=this.value.replace(/[^0-9]/g,''); autoSlash(this);" required>
														</div>
													</div>
												</div>
											</div>
													...
													<div class="form-group row">
														...
														<div class="col-md-9">
															...
															<input type="text" class="form-control" id="c_pNum" name="c_mobile" 
																   placeholder="ex) 01012345678" maxlength="11" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" required>
														</div>
													</div>
<!-- 													2020.08.07 김정미 -->
<!-- 													불필요한 입력란 div 삭제 -->
									...
									<div class="py-2">
										...
										<div class="form-group row">
											...
											<div class="col-md-6">
												...
												<input type="text" class="form-control" id="recieve-pNum" name="orderRecievePnum" placeholder="ex)01012345678" maxlength="11" required onKeyup="this.value=this.value.replace(/[^0-9]/g,'');">
											</div>
										</div>
...
<!-- 										2020.08.07 td id 추가 -->
											...
											<td class="text-right">${price[status.index] } 원</td>
										</tr>
<!-- 									2020.08.13 -->
<!-- 									결제 상품 정보 hidden값으로 설정 -->
										<input type="hidden" name="orderMerchanName" value="${name }">
										<input type="hidden" name="orderPrice" value="${price[status.index] }">
